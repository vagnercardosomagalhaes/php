<?php 
   ...
   $pesquisanome = $mysqli->real_escape_string($_GET['busca1']); // Proteção contra sql inject ==> $mysqli->real_escape_string
        ...
        $sql_code = "SELECT codigo,dataentr,contac,nomepax,descrpax,fornecedor,moeda,valtotal FROM mvv order by codigo";
            ...
            <a><figure><img src="../LogoPrincipal_quadrada.png" class="img-fluid" style="width:150px"></figure></a>
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex justify-content-between navbar navbar-dark" style="background-color:#4682b4">
                    <ul class="navbar-nav flex-grow-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="color:white" action="ListaVenda">Listagem de Vendas</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="text-center">
                ...
                <p>
                    <form class="form-inline" action="">
                        ...
                        <input type="date" name="busca1" placeholder="99/99/9999" style="width: 150px;">

                        <label class="my-1 mr-2" style="margin-left: 15px;"> até: </label>
                        <input type="date" name="busca2" placeholder="99/99/9999" style="width: 150px;">
                        <button type="submit" role=" button" class="btn btn-primary" style="margin-left: 10px;" >Lista Vendas</button>
                    </form>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr class="table">
                            ...
                            <th colspan="1" scope="col" class="text-xl-start">Pax</th>
                            <th colspan="1" scope="col" class="text-xl-start">Descrição</th>
                            <th colspan="1" scope="col" class="text-xl-start">fornecedor</th>
                            <th colspan="1" scope="col" class="text-xl-start">Moeda</th>
                            <th colspan="1" scope="col" class="text-xl-start">Total</th>                            
                        </tr>
                    </thead>
                    <tbody> 
                        <?php
                        ...
                        <?php    
                            ...
                            $sql_code = "SELECT codigo,dataentr,contac,nomepax,descrpax,fornecedor,moeda,valtotal FROM mvv  where dataentr>= '$data1' and  dataentr<= '$data2' order by codigo";                          
                                    ...
                                    while($dados = $sql_query->fetch_assoc())
                                    {
                                        ...
                                        <tr>
                                            <?php                                                    
                                                ...
                                                $numvend = strval($dados['codigo']);
                                                
                                                $valorFormatado = number_format($dados['valtotal'], 2, '.', '');
                                                $totlist = floatval($totlist) + floatval($valorFormatado);
                                                $totlist2 = number_format($totlist, 2, '.', '');
                                                //print $totlist2;                                                                                            
                                            ?>                                        
                                            ...
                                            <td class="text-start align-middle" style="font-size: 12px; height: auto; padding: 4px;" colspan="1"><?php echo $dados['contac']; ?></td>
                                            <td class="text-start align-middle" style="font-size: 12px; height: auto; padding: 4px;" colspan="1"><?php echo $dados['nomepax']; ?></td>
                                            <td class="text-start align-middle" style="font-size: 12px; height: auto; padding: 4px;" colspan="1"><?php echo $dados['descrpax']; ?></td>
                                            <td class="text-start align-middle" style="font-size: 12px; height: auto; padding: 4px;" colspan="1"><?php echo $dados['fornecedor']; ?></td>
                                            <td class="text-start align-middle" style="font-size: 12px; height: auto; padding: 4px;" colspan="1"><?php echo $dados['moeda']; ?></td>
                                            <td class="text-start align-middle" style="font-size: 12px; height: auto; padding: 4px;" colspan="1"><?php echo number_format($dados['valtotal'],2, ',','. '); ?></td>                                        
                                        </tr>
                                        <?php
                                    }                               
                                } 
                        ...
                        ?>
                        <h7 style="color: blue;">Total do Período:<?php echo $totlist2 ?> </h7>
                    </table> 
                    </tbody>
                </table>
            </div>
