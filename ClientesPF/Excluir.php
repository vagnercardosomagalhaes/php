<?php 
    ...
    if(!empty($_GET['id']))
    {
        ...
        $sql_code = "SELECT codigo, nome FROM clientes WHERE codigo = $codcli";
...
<header>
    ...
    <div class="text-center">
        <h3>Deseja realmente excluir as informações desse cliente: <?php echo $codcli; ?> - <?php echo $nomecli; ?></h3>
    </div>
    
    <div class="text-center">
        <a href="../ClientesPF/ClientesPFgrade.php" class="btn btn-primary" role="button">Cancelar exclusão</a>
        
        <a href="../ClientesPF/Deletar.php?id=<?php echo $_GET['id']; ?>" class="btn btn-danger" role="button" action="Deletar">Confirmar exclusão</a> 
    </div>
</body>
</html>
