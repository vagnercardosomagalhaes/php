<?php 
    ...
    {
        $codcli = $_GET['id'];
        $sqldelete = "Delete FROM clientes WHERE codigo = $codcli";
        $sqldeletedepen = "Delete FROM clidepen WHERE codigo = $codcli";
        
        $sqlresultdelete = $mysqli->query($sqldelete) or die("ERRO na tentativa de exclusão" . $mysqli->error); 
        $sqlresultdeletedepen = $mysqli->query($sqldeletedepen) or die("ERRO na tentativa de exclusão" . $mysqli->error);
    }  
...
<header>
            ...
            <div class="container-fluid" style="background-color:#4682b4">
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex justify-content-between navbar navbar-dark" style="background-color:#4682b4">
                    <ul class="navbar-nav flex-grow-1">
                        ...
                        <li class="nav-item">
                            <a href="../Atendiemntos/Atendgrade.php" class="nav-link" class="nav-link" style="color:white" action="Index">Atendimentos</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="text-center">
        <h3>Registro deletado com sucesso.</h3>
    </div>
