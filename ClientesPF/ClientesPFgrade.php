<?php 
   ...
   $pesquisanome = $mysqli->real_escape_string($_GET['busca']); // Proteção contra sql inject ==> $mysqli->real_escape_string
        ...
        $sql_code = "SELECT * FROM clientes WHERE nome like '%$pesquisanome%' || razao like '%$pesquisanome%'";
    ...
    <header>
        <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-light border-bottom box-shadow mb-3" style="background-color:#4682b4">
            <div class="container-fluid" style="background-color:#4682b4">
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex justify-content-between navbar navbar-dark" style="background-color:#4682b4">
                    <ul class="navbar-nav flex-grow-1">
                        ...
                        <li class="nav-item">
                            <a  style="color:white" class="nav-link" action="Cliente">Clientes - Pessoa Física</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="text-center">
                        ...
                        -->            
            <h1>Cadastro de clientes - Pessoa Física</h1>
            <p>
            <form action="">
            ...
            <div class="table-responsive - xl">
                <table class="table table-striped">
                    <thead>
                        <tr class="table" style="width: 70px;text-align: left; font-size: 14px;">
                    ...
                    <tbody> 
                        ...
                        <?php    
                            ...
                            $sql_code = "SELECT codigo, nome, endereco, bairro, cidade, telefone1, email FROM clientes WHERE nome like '%$pesquisanome%' OR razao like '%$pesquisanome%'";
                                ...
                                <?php
                                    ...
                                    while($dados = $sql_query->fetch_assoc())
                                    {
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="../ClientesPF/Excluir.php?id=<?php echo $dados['codigo']; ?>" role="button" class="btn btn-danger"  action="Excluir">Excluir</a>
                                        </div>
                                        -->    
                                        </td>                        
                                    </tr>
