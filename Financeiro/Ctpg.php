<?php 
   ...
   $pesquisanome = $mysqli->real_escape_string($_GET['busca1']); // Proteção contra sql inject ==> $mysqli->real_escape_string
        ...
        $sql_code = "SELECT origem, valor ,codvend,credor,data,discrimina,moeda FROM ctpg order by data";
                ...
                <table class="table table-striped">
                    ...
                    <tbody> 
                        ...
                        <?php    
                            ...
                            $sql_code2 = "SELECT valor, data FROM ctpg WHERE data >= '$data1' AND data <= '$data2' GROUP BY data ORDER BY data";
                            ...
                            $sql_code = "SELECT origem, valor, codvend,credor,data,discrimina,moeda FROM ctpg  where data>= '$data1' and  data<= '$data2' order by data";
