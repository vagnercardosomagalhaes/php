<?php 
  ...
  include('../conexao.php');
   ...
   $pesquisanome = $mysqli->real_escape_string($_GET['busca1']); // Proteção contra sql inject ==> $mysqli->real_escape_string
        ...
        $sql_code = "SELECT origem, valor ,codvend,credor,data,discrimina,moeda FROM saida order by data";
                ...
                <table class="table table-striped">
                    <thead>
                        <tr class="table">
                            ...
                            <th colspan="1" scope="col" class="text-xl-start">Credor</th>
                    ...
                    <tbody> 
                        ...
                        <?php    
                            ...
                            $sql_code2 = "SELECT valor, data FROM saida WHERE data >= '$data1' AND data <= '$data2' GROUP BY data ORDER BY data";
                            ...
                            $sql_code = "SELECT origem, valor, codvend,credor,data,discrimina,moeda FROM saida  where data>= '$data1' and  data<= '$data2' order by data";
                             ...
                             if($sql_query->num_rows == 0){
                                ...
                                while($dados = $sql_query->fetch_assoc())
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-start align-middle" style="font-size: 12px; height: auto; padding: 4px;" colspan="1"><?php echo $dados['credor']; ?></td>
