<?php 
  ...
  include('../conexao.php');
   ...
   $pesquisanome = $mysqli->real_escape_string($_GET['busca1']); // Proteção contra sql inject ==> $mysqli->real_escape_string
        ...
        $sql_code = "SELECT origem, valor ,codvend,devedor,data,discrimina,moeda FROM entrada order by data";
                ...
                <table class="table table-striped">
                    ...
                    <tbody> 
                        ...
                        <?php    
                            ...
                            $sql_code2 = "SELECT valor, data FROM entrada WHERE data >= '$data1' AND data <= '$data2' GROUP BY data ORDER BY data";
                            ...
                            $sql_code = "SELECT origem, valor, codvend,devedor,data,discrimina,moeda FROM entrada  where data>= '$data1' and  data<= '$data2' order by data";
