        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="2" align="left">Dependente 1</td>
                    <td colspan="2" align="left">21-55559999</td>
                    <td colspan="2" align="left">endereco@email.com.br</td>
                    <td>
                        <div class="btn-group" role="group">
                            <a role="button" class="btn btn-primary">Editar</a>
                            <a href="../ClientesPJ/Excluir.php" role="button" class="btn btn-danger">Excluir</a>
                        </div>
